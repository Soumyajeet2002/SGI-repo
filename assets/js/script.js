(function ($) {
  ...
  if ($(".project-two__carousel").length > 0) {
    const ProjectTwoCarousel = new Swiper('.project-two__carousel', {
      "slidesPerView": 4,
      "spaceBetween": 30,
      "speed": 600,
      "loop": true,
  ...
  // Products Three Carousel
  if ($(".products-three__carousel").length > 0) {
    const ProductsThreeCarousel = new Swiper('.products-three__carousel', {
      "slidesPerView": 4,
      "spaceBetween": 20,
      "speed": 600,
      "loop": true,
  ...
  // Farm For You Carousel
  if ($(".farm-for-you__carousel").length > 0) {
    const FarmForYouCarousel = new Swiper('.farm-for-you__carousel', {
      "slidesPerView": 4,
      "spaceBetween": 20,
      "speed": 600,
      "loop": true,
      "pagination": {
        "el": ".farm-for-you-dot-style1",
        "type": "bullets",
        "clickable": true
      },
  ...
  if ($(".testimonial-three__carousel").length > 0) {
    const TestimonialTwoCarousel = new Swiper('.testimonial-three__carousel', {
      "slidesPerView": 1,
      "spaceBetween": 30,
      "speed": 600,
      "loop": true,
  ...
  // Offer One Carousel
  if ($(".offer-one__carousel").length > 0) {
    const TestimonialTwoCarousel = new Swiper('.offer-one__carousel', {
      "slidesPerView": 1,
      "spaceBetween": 30,
      "speed": 600,
      "loop": true,
      "pagination": {
        "el": ".offer-one-dot-style1",
        "type": "bullets",
        "clickable": true
      },
...
if ($(".accordion-grp").length) {
        ...
        accordion.each(function () {
            $(this)
                ...
                .on("click", function () {
                    ...
                    // If not active → open it and close others
                    else {
  ...
  $(window).on("load", function () {
    ...
    // Curved Circle
    if ($(".video-one__curved-circle-2").length) {
      $(".video-one__curved-circle-2").circleType({
        position: "absolute",
        dir: 1,
        radius: -180,
        forceHeight: true,
    ...
    // Curved Circle
    if ($(".activities-one__curved-circle").length) {
      $(".activities-one__curved-circle").circleType({
        position: "absolute",
        dir: 1,
        radius: 80,
        forceHeight: true,
